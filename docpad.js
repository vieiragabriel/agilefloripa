  ...
  templateData: {
    ...
    schedule: [
        ...
        },
        {
            ...
            company: "CIASC",
            bio: "Bacharel em Computação com mais de 10 anos de atuação em áreas de negócio tão distintas quanto telecomunicações, representação comercial e governança pública. Entusiasta dos temas que podem colaborar para a eficiência do serviço público, atualmente é Product Owner no CIASC, colaborando com as atividades dos times que atendem à Secretaria da Fazenda de SC.",
            presentation: {
