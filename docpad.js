module.exports = {
  ...
  templateData: {
    ...
    callToAction: {
      text: "Inscreva-se já!",
      link: "https://inscricoes.agilebrazil.com/events/42/attendances/new"
    },
    ...
    courses: [
      {
        ...
        presentation: {
          ...
          time: "09:00 às 18:00",
          value:
            "Promocional (até 16/Nov): R$ 790 / Agile Floripa (até 30/11): R$ 890 / Normal (até 04/12): R$ 990",
          cta:
            "https://www.sympla.com.br/lean-business-analysis-for-product-owners-16h__206842",
          ctaText: "Inscreva-se"
        }
      },
      {
        ...
        presentation: {
          ...
          time: "08:00 às 17:00",
          value:
            "Early Bird (10 vagas ou até 15/Nov): R$ 1.150 / Normal (10 vagas ou até 5/Dez): R$ 1.350",
    ...
    schedule: [
      ...
      },
      {
        ...
        photo: "themes/agile-floripa/img/speaker/paulo-antiquera.jpg",
        company: "ArcTouch",
        bio:
      ...
      },
      {
        ...
        presentation: {
          title:
            "Os Desafios e Benefícios da Agilidade para Times Remotos - Dicas e Técnicas para Garantir Resultados Expressivos.",
          description:
    ...
    workshops: [
      {
        title:
          "STATIK - Começando com Kanban (em escala) na próxima segunda-feira",
        time: "10:30",
        instructors: [
          {
            name: "Rodrigo Yoshima",
      ...
      },
      {
        ...
        description:
          "Há diversas técnicas para ajudar na criação de um excelente produto. No entanto, nosso esforço pode ser em vão se não aproveitarmos a criatividade do time, entrarmos em consenso sobre nossos objetivos, prioridades e validarmos nossas hipóteses, escutando nossos usuários. Neste workshop você aprenderá técnicas de consenso 100% na prática, buscando, através de muita empatia, alinhar as demandas dos stakeholders com as necessidades dos usuários e da equipe envolvida. Público alvo: pessoas que trabalham ou gostariam de trabalhar com criação de produtos e em projetos, dentro e fora de TI."
      },
      {
        title: "Coffee break",
        time: "16:00"
    ...
    partners: [
      {
        ...
        logo:
          "themes/agile-floripa/img/sponsor/agilealliance-brazil_inverted_box.png",
        url: "https://www.agilealliance.org/pt/"
      },
      {
        name: "Agile Brazil",
